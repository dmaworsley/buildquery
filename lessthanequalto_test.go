...
func TestLessThanEqualToSingleCall(t *testing.T) {
	...
	query.LessThanEqualTo(want)

	got := query.SelectSQL.lessThanEqualTo
...
func TestLessThanEqualToMultiCall(t *testing.T) {
	...
	//add first set cols
	query.LessThanEqualTo(cols_inital)
	...
	//add more columns
	query.LessThanEqualTo(cols_again)
